...
<body>
            ...
            <main class="page-main flex-1">
                <div class="max-w-site mx-auto px-4">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
                        ...
                        <a href="<?= htmlspecialchars(route_url('km_report.php')) ?>" class="nav-card">
                        ...
                        <a href="<?= htmlspecialchars(route_url('gerenciamento_usuarios.php')) ?>" class="nav-card">
                            <div class="flex items-center gap-3 min-w-0">
                        ...
                        <a href="<?= htmlspecialchars(route_url('access_logs.php')) ?>" class="nav-card">
                            <div class="flex items-center gap-3 min-w-0">
    ...
    <script src="<?= htmlspecialchars(asset_url('js/escala-admin.js')) ?>?v=<?= time() ?>"></script>
</body>
